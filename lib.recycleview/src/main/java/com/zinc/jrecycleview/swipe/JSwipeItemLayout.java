...
public class JSwipeItemLayout extends FrameLayout {
    ...
    public static final String TAG = "JSwipeItemLayout";
    ...
    public JSwipeItemLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JSwipeItemLayout(Context context, AttributeSet attrs, int defStyleAttr) {
...
//    }
    ...
    //获取ContentView，最后一个view，这个是规定（按照layout布局）
